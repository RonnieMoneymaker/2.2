...
const Analytics: React.FC = () => {
  ...
  const salesOverTime = Array.from({length: 30}, (_, i) => {
    ...
    return {
      ...
      customers: 2 + Math.floor(Math.random() * 5),
      avg_order_value: 80 + Math.random() * 60
    };
  });

  const customerSegments = [
    { name: 'VIP Klanten', value: 1, color: '#8B5CF6' },
    { name: 'Actieve Klanten', value: 2, color: '#10B981' },
    { name: 'Nieuwe Klanten', value: 1, color: '#3B82F6' },
    { name: 'Inactieve Klanten', value: 0, color: '#6B7280' }
  ];

  const productPerformance = [
    { name: 'Premium T-Shirt', sales: 45, revenue: 1349.55, margin: 58.3 },
    { name: 'Jeans Classic', sales: 32, revenue: 2559.68, margin: 68.8 },
    { name: 'Sneakers Sport', sales: 18, revenue: 1619.82, margin: 61.1 },
    { name: 'Hoodie Deluxe', sales: 28, revenue: 1399.72, margin: 62.5 },
    { name: 'Backpack Travel', sales: 12, revenue: 839.88, margin: 68.6 }
  ];

  const channelPerformance = [
    { channel: 'Direct', revenue: 4200, orders: 42, conversion: 3.2 },
    { channel: 'Google Ads', revenue: 2800, orders: 28, conversion: 2.8 },
    { channel: 'Meta Ads', revenue: 1900, orders: 19, conversion: 2.1 },
    { channel: 'Email', revenue: 1100, orders: 11, conversion: 4.5 },
    { channel: 'Organic Search', revenue: 900, orders: 9, conversion: 1.8 }
  ];

  const cohortData = [
    { month: 'Jan', new_customers: 15, retained_month_1: 12, retained_month_2: 8, retained_month_3: 6 },
    { month: 'Feb', new_customers: 18, retained_month_1: 14, retained_month_2: 10, retained_month_3: 7 },
    { month: 'Mrt', new_customers: 22, retained_month_1: 17, retained_month_2: 12, retained_month_3: 8 },
    { month: 'Apr', new_customers: 20, retained_month_1: 15, retained_month_2: 11, retained_month_3: null },
    { month: 'Mei', new_customers: 25, retained_month_1: 19, retained_month_2: null, retained_month_3: null },
    { month: 'Jun', new_customers: 28, retained_month_1: null, retained_month_2: null, retained_month_3: null }
  ];
  ...
  const profitData = Array.from({length: 30}, (_, i) => {
    const date = new Date();
    date.setDate(date.getDate() - (29 - i));
    const revenue = 300 + Math.random() * 400;
    ...
    <Layout title="Analytics & Winst">
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <StatsCard
            title="Totale Omzet"
            value={formatCurrency(10900)}
            change="+12.5% vs vorige periode"
            changeType="positive"
            icon={Euro}
            color="green"
          />
          ...
          <StatsCard
            ...
            value={formatCurrency(101.28)}
            change="+€5.20 vs vorige periode"
            changeType="positive"
            icon={TrendingUp}
            color="purple"
          />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="text-2xl font-bold text-gray-900">€28.50</div>
            <div className="text-sm text-green-600">-€3.20 vs vorige maand</div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="text-2xl font-bold text-gray-900">€245.80</div>
            <div className="text-sm text-green-600">+€15.30 vs vorige maand</div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="text-sm text-green-600">+0.4x vs vorige maand</div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="text-sm text-red-600">+2.1% vs vorige maand</div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="text-sm text-green-600">+0:45 vs vorige maand</div>
          </div>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <div className="text-sm text-green-600">+2.1% vs vorige maand</div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <ul className="space-y-1 text-sm text-gray-700">
                <li>• Jeans Classic Fit heeft de hoogste omzet (€2.559,68)</li>
                <li>• Direct traffic heeft beste conversie (3.2%)</li>
                <li>• Email marketing heeft hoogste ROI (4.5% conversie)</li>
                <li>• Customer retention verbetert (34.2% repeat rate)</li>
              </ul>
            </div>
            <div>
              <h4 className="font-medium text-gray-900 mb-2">💡 Aanbevelingen:</h4>
              <ul className="space-y-1 text-sm text-gray-700">
                <li>• Verhoog email marketing budget (beste ROI)</li>
                <li>• Focus op cart abandonment reductie (68.5% is hoog)</li>
                <li>• Promoot Jeans Classic Fit meer (top performer)</li>
                <li>• Optimaliseer organic search (laagste conversie)</li>
              </ul>
            </div>
          </div>
        </div>

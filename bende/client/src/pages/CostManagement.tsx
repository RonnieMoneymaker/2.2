...
const CostManagement: React.FC = () => {
  ...
  const fetchCosts = async () => {
    try {
      ...
      // Mock data fallback
      const mockCosts: FixedCost[] = [
        {
          id: 1,
          name: 'Kantoorhuur',
          description: 'Maandelijkse huur kantoorpand',
          category: 'Huisvesting',
          amount: 2500.00,
        ...
        },
        {
          ...
          description: 'KPN Business pakket',
          category: 'Utilities',
          amount: 89.95,
          billing_cycle: 'monthly',
          start_date: '2024-01-01',
      ...
      const mockSummary: CostSummary[] = [
        { category: 'Huisvesting', cost_items: 1, monthly_total: 2500.00, yearly_total: 30000.00 },
        { category: 'Utilities', cost_items: 1, monthly_total: 89.95, yearly_total: 1079.40 },
        { category: 'Software', cost_items: 1, monthly_total: 49.99, yearly_total: 599.88 }
      ];
      
      setCosts(mockCosts);
      setSummary(mockSummary);
      setTotals({ total_items: 3, total_monthly: 2639.94, total_yearly: 31679.28 });
    } finally {
      setLoading(false);
    }
  };

...
const Products: React.FC = () => {
  ...
  // Mock data with real profit calculations (selling - purchase - shipping)
  const mockProducts: Product[] = [
    {
      id: 1,
      name: 'Premium T-Shirt',
      sku: 'TSH-001',
      description: 'Hoogwaardige katoenen t-shirt',
      category: 'Kleding',
      purchase_price: 12.50,
      selling_price: 29.99,
      stock_quantity: 150,
      supplier: 'TextielGrossier BV',
      weight_grams: 200,
      shipping_cost: 3.95,
      primary_image_url: 'https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=400',
      gross_margin: 29.99 - 12.50 - 3.95, // Real profit: 13.54
      margin_percentage: ((29.99 - 12.50 - 3.95) / 29.99) * 100, // 45.1%
      quantity_sold: 45,
      revenue: 1349.55,
      real_profit: 45 * (29.99 - 12.50 - 3.95), // 609.30
      orders_count: 28
    },
    {
      id: 2,
      ...
      sku: 'JNS-002',
      description: 'Klassieke jeans in verschillende maten',
      category: 'Kleding',
      purchase_price: 25.00,
      selling_price: 79.99,
      stock_quantity: 75,
      supplier: 'DenimSupply Co',
      weight_grams: 400,
      shipping_cost: 4.95,
      primary_image_url: 'https://images.unsplash.com/photo-1542272604-787c3835535d?w=400',
      gross_margin: 79.99 - 25.00 - 4.95, // Real profit: 50.04
      margin_percentage: ((79.99 - 25.00 - 4.95) / 79.99) * 100, // 62.6%
      quantity_sold: 32,
      revenue: 2559.68,
      real_profit: 32 * (79.99 - 25.00 - 4.95), // 1601.28
      orders_count: 25
    },
    {
      id: 3,
      name: 'Sneakers Sport',
      sku: 'SNK-003',
      description: 'Comfortabele sport sneakers',
      category: 'Schoenen',
      purchase_price: 35.00,
      selling_price: 89.99,
      stock_quantity: 50,
      supplier: 'FootwearDirect',
      weight_grams: 800,
      shipping_cost: 6.95,
      primary_image_url: 'https://images.unsplash.com/photo-1549298916-b41d501d3772?w=400',
      gross_margin: 89.99 - 35.00 - 6.95, // Real profit: 48.04
      margin_percentage: ((89.99 - 35.00 - 6.95) / 89.99) * 100, // 53.4%
      quantity_sold: 18,
      revenue: 1619.82,
      real_profit: 18 * (89.99 - 35.00 - 6.95), // 864.72
      orders_count: 15
    },
    {
      id: 4,
      name: 'Hoodie Deluxe',
      sku: 'HDI-004',
      description: 'Warme hoodie met capuchon',
      category: 'Kleding',
      ...
      gross_margin: 49.99 - 18.75 - 5.95, // Real profit: 25.29
      margin_percentage: ((49.99 - 18.75 - 5.95) / 49.99) * 100, // 50.6%
      quantity_sold: 28,
      revenue: 1399.72,
      real_profit: 28 * (49.99 - 18.75 - 5.95), // 708.12
      orders_count: 22
    },
    {
      id: 5,
      ...
      sku: 'BAG-005',
      description: 'Duurzame reistas met laptop compartiment',
      category: 'Accessoires',
      purchase_price: 22.00,
      selling_price: 69.99,
      stock_quantity: 30,
      supplier: 'BagWorld Ltd',
      weight_grams: 1200,
      shipping_cost: 8.95,
      primary_image_url: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=400',
      gross_margin: 69.99 - 22.00 - 8.95, // Real profit: 39.04
      margin_percentage: ((69.99 - 22.00 - 8.95) / 69.99) * 100, // 55.8%
      quantity_sold: 12,
      revenue: 839.88,
      real_profit: 12 * (69.99 - 22.00 - 8.95), // 468.48
      orders_count: 10
    }
  ];

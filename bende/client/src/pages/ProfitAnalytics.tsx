      ...
      if (response.ok) {
        ...
        const mockAnalysis: ProfitAnalysis = {
          ...
          summary: {
            ...
            total_fixed_costs: 11825.00,
            total_ad_spend: 2441.80,
            net_profit: -4816.80,
            gross_margin: 60.0,
            net_margin: -30.6,
            break_even_revenue: 23777.33,
            orders_count: 156,
          ...
          breakdown: {
            revenue_by_category: [
              { category: 'Kleding', revenue: 8900.00, cogs: 3560.00, gross_profit: 5340.00, units_sold: 178 },
              { category: 'Schoenen', revenue: 4500.00, cogs: 1800.00, gross_profit: 2700.00, units_sold: 50 },
              { category: 'Accessoires', revenue: 2350.00, cogs: 940.00, gross_profit: 1410.00, units_sold: 84 }
            ],
            daily_trend: Array.from({length: parseInt(period)}, (_, i) => {
              const date = new Date(Date.now() - i * 24 * 60 * 60 * 1000);
              const baseRevenue = 450 + Math.random() * 200;
              return {
                date: date.toISOString().split('T')[0],
                daily_revenue: baseRevenue,
                daily_cogs: baseRevenue * 0.4,
                daily_gross_profit: baseRevenue * 0.6,
                orders_count: Math.floor(baseRevenue / 85)
              };
            }).reverse(),
            cost_structure: {
              cogs_percentage: 40.0,
              fixed_costs_percentage: 75.1,
              ad_spend_percentage: 15.5
            }
          }
        };

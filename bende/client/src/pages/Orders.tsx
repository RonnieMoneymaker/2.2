  ...
  const mockOrders: Order[] = [
    {
      ...
      order_date: '2024-09-01T10:30:00Z',
      status: 'delivered',
      total_amount: 99.99,
      currency: 'EUR',
      payment_method: 'iDEAL',
      shipping_address: 'Hoofdstraat 123, 1000 AB Amsterdam',
      first_name: 'Jan',
      last_name: 'de Vries',
    ...
    },
    {
      ...
      order_date: '2024-09-03T09:45:00Z',
      status: 'processing',
      total_amount: 49.99,
      currency: 'EUR',
      payment_method: 'iDEAL',
    ...
    },
    {
      ...
      order_date: '2024-08-30T16:20:00Z',
      status: 'delivered',
      total_amount: 89.99,
      currency: 'EUR',
      payment_method: 'PayPal',
      shipping_address: 'Kerkstraat 45, 3500 CD Utrecht',
      first_name: 'Maria',
      last_name: 'Jansen',
    ...
    },
    {
      ...
      order_date: '2024-09-02T11:10:00Z',
      status: 'shipped',
      total_amount: 199.99,
      currency: 'EUR',
      payment_method: 'iDEAL',
      shipping_address: 'Dorpsplein 7, 2000 EF Haarlem',
  ...
  const fetchOrders = async () => {
    try {
      ...
      setPagination(response.data.pagination || {
        ...
        pages: Math.ceil(mockOrders.length / 20)
      });
    } catch (error) {

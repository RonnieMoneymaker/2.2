...
const ShippingRules: React.FC = () => {
  ...
  // Mock data with comprehensive shipping rules
  const mockRules: ShippingRule[] = [
    {
      id: 1,
      name: 'Nederland - Kleine pakketten',
      country: 'Nederland',
      min_weight: 0,
      max_weight: 500,
      min_order_value: 0,
      ...
      shipping_cost: 3.95,
      free_shipping_threshold: 50,
      description: 'Brievenbuspakjes tot 500g'
    },
    {
      id: 2,
      name: 'Nederland - Standaard pakketten',
      country: 'Nederland',
      min_weight: 501,
      max_weight: 2000,
      min_order_value: 0,
      ...
      shipping_cost: 6.95,
      free_shipping_threshold: 50,
      description: 'Normale pakketten 0.5-2kg'
    },
    {
      id: 3,
      name: 'Nederland - Grote pakketten',
      country: 'Nederland',
      min_weight: 2001,
      max_weight: 10000,
      min_order_value: 0,
      ...
      description: 'Zware pakketten 2-10kg'
    },
    {
      id: 4,
      name: 'Nederland - Gratis verzending',
      country: 'Nederland',
      min_weight: 0,
      max_weight: 2000,
      min_order_value: 50,
    ...
    {
      id: 5,
      name: 'België - Standaard',
      country: 'België',
      min_weight: 0,
      max_weight: 2000,
      min_order_value: 0,
      max_order_value: 74.99,
      shipping_cost: 7.95,
      free_shipping_threshold: 75,
      description: 'België standaard verzending'
    },
    {
      id: 6,
      name: 'Duitsland - Express',
      country: 'Duitsland',
      min_weight: 0,
      max_weight: 5000,
      min_order_value: 0,
      max_order_value: 999999,
      shipping_cost: 14.95,
      description: 'Express verzending naar Duitsland'
    }
  ];

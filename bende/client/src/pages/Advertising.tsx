...
const Advertising: React.FC = () => {
  ...
  const fetchAdvertisingData = async () => {
    try {
      ...
      const mockOverview: AdOverview = {
        totalCampaigns: { count: 4 },
        activeCampaigns: { count: 3 },
        totalSpend: { total: 2441.80 },
        totalConversions: { total: 312 },
        platformPerformance: [
          {
            platform: 'google',
            campaigns: 2,
        ...
        dailyPerformance: [
          { date: '2024-01-01', impressions: 12000, clicks: 600, spent: 350, conversions: 45, revenue: 1800 },
          { date: '2024-01-02', impressions: 11500, clicks: 575, spent: 325, conversions: 42, revenue: 1650 },
          { date: '2024-01-03', impressions: 13000, clicks: 650, spent: 380, conversions: 48, revenue: 1920 },
          { date: '2024-01-04', impressions: 12500, clicks: 625, spent: 365, conversions: 46, revenue: 1750 },
          { date: '2024-01-05', impressions: 14000, clicks: 700, spent: 400, conversions: 52, revenue: 2100 },
          { date: '2024-01-06', impressions: 13500, clicks: 675, spent: 385, conversions: 49, revenue: 1980 },
          { date: '2024-01-07', impressions: 15000, clicks: 750, spent: 425, conversions: 55, revenue: 2200 }
        ],
        topCampaigns: [
          {
            id: 1,
            name: 'Zomer Collectie 2024',
            platform: 'google',
            status: 'active',
            budget: 1000,
            spent: 750.50,
      ...
      setCampaigns(mockOverview.topCampaigns);
    } catch (error) {
